...
def main():
    ...
    test_path       = '/gpfs/fs7/grdi/genarcc/wp1/genomics_unit/IAV/Retrain/data/04_HA_RNA_Host/' #test data unchanged   
    model_save_path = '/gpfs/fs7/grdi/genarcc/wp1/genomics_unit/IAV/Revision_1/model_weight/04_HA_RNA_Host/' #need to change here
    ablation_result = '/fs/vnas_Hcfia/orph/hon000/revision_1/results/04_HA_RNA_Host/' #change here
