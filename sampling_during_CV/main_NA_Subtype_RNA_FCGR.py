...
def main():
    ...
    test_path       = '/gpfs/fs7/grdi/genarcc/wp1/genomics_unit/IAV/Retrain/data/06_NA_RNA_Subtype/' #test data unchanged   
    model_save_path = '/gpfs/fs7/grdi/genarcc/wp1/genomics_unit/IAV/Revision_1/model_weight/06_NA_RNA_Subtype/' #need to change here
    ablation_result = '/fs/vnas_Hcfia/orph/hon000/revision_1/results/06_NA_RNA_Subtype/' #change here
