...
def main():
    ...
    train_path      = '/gpfs/fs7/grdi/genarcc/wp1/genomics_unit/IAV/Retrain/data/Full_Train_Data/06_NA_RNA/'
    test_path       = '/gpfs/fs7/grdi/genarcc/wp1/genomics_unit/IAV/Retrain/data/06_NA_RNA_Host/' #test data unchanged   
    model_save_path = '/gpfs/fs7/grdi/genarcc/wp1/genomics_unit/IAV/Revision_1/model_weight/06_NA_RNA_Host/' #need to change here
    ablation_result = '/fs/vnas_Hcfia/orph/hon000/revision_1/results/06_NA_RNA_Host/' #change here

    # train data pre 2020 (good quality) full data
    X_train = np.load(train_path + 'X_train_fcgr.npy')
    y_train = np.load(train_path + 'y_train_host.npy')
    

    # test data post 2020 (good quality)
    X_test_high_quality = np.load(test_path + 'X_test_high_fcgr.npy')
    y_test_high_quality = np.load(test_path + 'y_test_high.npy')
    
    
    # test data post 2020 (poor quality)
    X_test_low_quality_post2020 = np.load(test_path + 'X_test_low_fcgr.npy')
