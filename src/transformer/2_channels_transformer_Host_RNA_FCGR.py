...
def main():
    ...
    path            = '/gpfs/fs7/grdi/genarcc/wp1/genomics_unit/IAV/Retrain/data/2_Channels_RNA_Host/'
    ablation_result = '/fs/vnas_Hcfia/orph/hon000/retrain/transformer/result/2_Channels_RNA_Host/'
    model_weights   = '/gpfs/fs7/grdi/genarcc/wp1/genomics_unit/IAV/Retrain/model_weight/transformer/2_Channels_RNA_Host/'

    # train data pre 2020 (good quality)
    X_train = np.load(path + 'X_train_fcgr.npy')
