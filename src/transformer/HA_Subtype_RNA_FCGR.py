...
def main():
    ...
    ablation_result = '/fs/vnas_Hcfia/orph/hon000/retrain/transformer/result/04_HA_RNA_Subtype/'
    model_weights   = '/gpfs/fs7/grdi/genarcc/wp1/genomics_unit/IAV/Retrain/model_weight/transformer/04_HA_RNA_Subtype/'
