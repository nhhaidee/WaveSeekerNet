...
def main():
    ...
    ablation_result = '/fs/vnas_Hcfia/orph/hon000/retrain/transformer_esm/result/06_NA_Protein_Subtype_t12/'
    model_weights   = '/gpfs/fs7/grdi/genarcc/wp1/genomics_unit/IAV/Retrain/model_weight/transformer_esm/06_NA_Protein_Subtype_t12/'
