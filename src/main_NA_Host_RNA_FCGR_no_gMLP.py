...
def main():
    ...
    path            = '/gpfs/fs7/grdi/genarcc/wp1/genomics_unit/IAV/Retrain/data/06_NA_RNA_Host/'
    model_save_path = '/gpfs/fs7/grdi/genarcc/wp1/genomics_unit/IAV/Retrain/model_weight/06_NA_RNA_Host/'
    ablation_result = '/fs/vnas_Hcfia/orph/hon000/retrain/results_no_gmlp/06_NA_RNA_Host/'
