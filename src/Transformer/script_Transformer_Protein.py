...
def main():
    ...
    ablation_result = '/fs/vnas_Hcfia/orph/hon000/revision_1/transformer/result/04_HA_Protein_Subtype/'
    model_weights   = '/gpfs/fs7/grdi/genarcc/wp1/genomics_unit/IAV/Revision_1/model_weight/transformer/04_HA_Protein_Subtype/'
    ...
    X_test_low_quality = np.load(test_path + 'X_test_low_onehot.npy')
    y_test_low_quality = np.load(test_path + 'y_test_low.npy')
