...
class TransformerBlock(nn.Module):
    def __init__(self, num_classes, embedding_dim=320):
        ...
        self.transformer, _ = esm.pretrained.load_model_and_alphabet("pretrained_model/esm2_t6_8M_UR50D.pt")
    ...
    def forward(self,inputs):
        x = self.transformer(inputs, repr_layers=[6])#, return_contacts=True)
        x = x["representations"][6]
