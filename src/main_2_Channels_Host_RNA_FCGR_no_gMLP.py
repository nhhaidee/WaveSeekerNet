...
def main():
    ...
    model_save_path = '/gpfs/fs7/grdi/genarcc/wp1/genomics_unit/IAV/Retrain/model_weight/2_Channels_RNA_Host/'
    ablation_result = '/fs/vnas_Hcfia/orph/hon000/retrain/results_no_gmlp/2_Channels_RNA_Host/'
    ...
    X_test_low_quality_post2020 = np.load(path + 'X_test_low_fcgr.npy')
